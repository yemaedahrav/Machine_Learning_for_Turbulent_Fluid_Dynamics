...
file_list = ["ret60_s4_z-theta_t_0.txt",  "ret60_s4_z-theta_t_1.txt",  "ret60_s4_z-theta_t_2.txt",  "ret60_s4_z-theta_t_3.txt"]
...
for i in range(len(file_list)):
    ...
    result_dir = "/users/avarhard/scratch/ret60_3_nl_g_s4/t_"+str(i)
    f = plt.figure()
    f.set_figwidth(12)
    f.set_figheight(10)
    ...
    file_name = "/s4_heatmap_" + str(i)+".png"
