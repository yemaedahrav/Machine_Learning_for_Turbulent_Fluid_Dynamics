...
file_base = "ret60_s4_z-theta_t_"
results_base = "/home/ameyv6/Machine_Learning_for_Turbulent_Fluid_Dynamics/Complete_Real_Data_Analysis/Nonlinear-Transitional/ret60_3_nl_g_s4"
colors = ['maroon','orange','lime','royalblue']
...
for th in range(0,N_th,15):
    ...
    for iter in range(4):   
        plt.plot(array_dict[iter][:128,th],color=colors[iter], marker='o', linestyle='dashed',linewidth=1, markersize=4, label=iter)
...
for z in range(0,N_z,15):
    ...
    for iter in range(4):   
        plt.plot(array_dict[iter][z,:128],color=colors[iter], marker='o', linestyle='dashed',linewidth=1, markersize=4, label=iter)
